  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-black text-white font-sans relative overflow-hidden'>
      ...
      <div className='flex flex-col justify-center items-center py-10 gap-40 p-4'>
        <section className='flex flex-col justify-center items-center gap-40'>
          <div className="mt-0 flex flex-col justify-center gap-4">
            <div className="flex flex-col items-center space-y-2">
              <h2 className="text-4xl md:text-4xl lg:text-7xl font-bold text-center text-white font-sans tracking-tight">
                AI Product Photos That Help You
              </h2>
              <div className="h-[1.5em] relative mx-auto mb-8">
                <div className="relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 text-4xl md:text-4xl lg:text-7xl font-bold">
                  <span>{displayText}</span>
                </div>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-[60%] mx-auto py-2 mt-10">
        ...
        <div className="w-full text-center mb-4"> {/* New container for text and BrandSection */}
          <h2 className="text-2xl md:text-2xl lg:text-4xl font-bold text-white mb-5">
          Compatible with Industry Leaders
          </h2>
          <BrandSection /> {/* BrandSection component */}
        </div>
